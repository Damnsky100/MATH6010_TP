...
The raw data is from compustat database.
...
```{r}
# Run all the data cleaning functions....
  ...
  # Vol data
  # (mettre pour load ici au lieu de dans la fonction)
```
...
```{r}
list_ratios_technicals <- f_compute_ratios_technicals(stocks_symbols, 100, 2)
...
```{r}
# Generate the out of sample data to train the classification
